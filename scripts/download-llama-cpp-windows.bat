...
set "LLAMA_CPP_VERSION=b9986"
set "LLAMA_CPP_URL=https://github.com/ggml-org/llama.cpp/releases/download/b9986/llama-b9986-bin-win-cuda-12.4-x64.zip"
set "LLAMA_CPP_SHA256=0feaaac317856ac7c33131edb95851ef99731a7af97a7ee4a856b76a828ad1c2"
